...
import { FiSearch, FiHeart, FiLogOut, FiUser, FiChevronDown } from "react-icons/fi";
...
export default function HomeHeader() {
  ...
  // Toggle search and clear input when closing
  const toggleSearch = () => {
    if (showSearch) {
      setSearchQuery("");
    }
        ...
        <div className="flex items-center gap-2 relative">
          ...
          {user ? (
            <div className="relative" ref={userMenuRef}>
              ...
              {showUserMenu && (
                <div className="absolute right-0 mt-2 w-[220px] bg-white border border-[#e6e0e9] rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.10)] py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
