export default function HomeFooter() {
  return (
    <footer className="bg-white border-t border-[#e6e0e9] pt-12 lg:pt-16 px-4 sm:px-8 lg:px-16">
      <div className="max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 pb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-[#49454f] leading-[1.7] mb-6 max-w-xs">
            ...
            <div className="flex gap-3">
              {[
                ...
                <button
                  key={i}
                  className="w-10 h-10 rounded-full bg-[#f2ecf4] border-none cursor-pointer flex items-center justify-center hover:bg-[#e9ddff] transition-colors"
                >
          ...
          <div>
            ...
            {["All Collections", "New Arrivals", "Women", "Men", "Accessories"].map((link) => (
              <a
                key={link}
                href="#"
                className="block text-sm text-[#49454f] no-underline mb-3 hover:text-[#4f378a] transition-colors"
              >
                {link}
              </a>
            ))}
          ...
          <div>
            ...
            {["Shipping & Returns", "Privacy Policy", "Terms of Service", "Sustainability", "Contact Us"].map(
              (link) => (
                <a
                  key={link}
                  href="#"
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#e6e0e9] py-6 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-sm text-[#7a7582] text-center sm:text-left">
            © 2026 PEAK LUXE. CURATED MINIMALISM.
          </p>
